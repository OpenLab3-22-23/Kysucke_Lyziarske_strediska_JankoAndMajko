...
var MultiSelectUnstyled = React31.forwardRef(function MultiSelectUnstyled2(props, forwardedRef) {
...
var Rating = React57.forwardRef(function Rating2(inProps, ref) {
  ...
  const handleMouseMove = (event) => {
    ...
    if (theme.direction === "rtl") {
      percent = (right2 - event.clientX) / (width * max2);
    } else {
      percent = (event.clientX - left2) / (width * max2);
    }
    let newHover = roundValueToPrecision(max2 * percent + precision / 2, precision);
    newHover = clamp2(newHover, precision, max2);
